...
| DELETE | `/api/sessions/{sid}` | Delete a session file | **Yes** | — | âœ“ |
| POST | `/api/sessions/{sid}/rename` | Update session title | **Yes** | — | âœ“ |
...
| POST | `/api/files/write` | Write a file via `_resolve` | **Always** | — | âœ“ |
| GET | `/api/files/browse` | List a directory | **Yes** | 30/min | — |
| GET | `/api/files/drives` | List drives (Windows) or root dirs | — | — | — |
| POST | `/api/files/upload` | Stream-upload to `output/` (10MB cap) | **Yes** | — | âœ“ |
| POST | `/api/files/debug` | AI fix-in-place on a file | **Always** | — | âœ“ |
...
|---|---|---|
| Most deps (fastapi, uvicorn, pydantic, python-pptx, pillow, whisper…) | MIT / Apache-2.0 / BSD | None for normal use |
